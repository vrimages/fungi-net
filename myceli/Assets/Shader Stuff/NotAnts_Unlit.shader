...
Shader "Unlit/NotAnts_Unlit"
{
    ...
    SubShader
    {
        ...
        //RWStructuredBuffer<float4> _BufferA2;
        //RWStructuredBuffer<float4> _BufferB2;
        ...
        { 
            ...
            float4 getv2(float2 p, float2 uv:TEXCOORD0)
            {
                ...
                return _BufferA2.Load(int3(p,0));
            }
            ...
            float4 getvb(float2 p, float2 uv:TEXCOORD0)
            {
                ...
                return _BufferB2.Load(int3(p,0));
            }
